...
\begin{titlepage}\centering
  ...
  \begin{tabular}{lll}
    ...
    \RA Arun(2401010098)         & Streamlit UI, Prediction API, Deployment      & 35\% \\
    \RB Mayank Yadav(2401010271) & Data Preprocessing, Modelling, Engineering    & 35\% \\
    \RA Rohit Kumar(2401010392)  & EDA, Evaluation, Visualisation, Documentation & 30\% \\
  \end{tabular}
